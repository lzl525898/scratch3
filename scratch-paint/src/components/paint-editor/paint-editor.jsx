                ...
                {this.state.canvas ? (
                    <div className={styles.editorContainerTop}>
                        ...
                        <div className={styles.row}>
                            {/* Name field */}
                            <InputGroup>
                                <Label text={'造型'/*this.props.intl.formatMessage(messages.costume)*/}>
                                    <BufferedInput
                                        type="text"
                            ...
                            <InputGroup className={styles.modDashedBorder}>
                                <LabeledIconButton
                                    ...
                                    imgSrc={groupIcon}
                                    title={'分组'/*this.props.intl.formatMessage(messages.group)*/}
                                    onClick={this.props.onGroup}
                                />
                                <LabeledIconButton
                                    disabled={!shouldShowUngroup()}
                                    imgSrc={ungroupIcon}
                                    title={'取消分组'/*this.props.intl.formatMessage(messages.ungroup)*/}
                            ...
                            <InputGroup className={styles.modDashedBorder}>
                                <LabeledIconButton
                                    ...
                                    title={'前进'/*this.props.intl.formatMessage(messages.forward)*/}
                                    onClick={this.props.onSendForward}
                                />
                                <LabeledIconButton
                                    disabled={!shouldShowSendBackward()}
                                    imgSrc={sendBackwardIcon}
                                    title={'后退'/*this.props.intl.formatMessage(messages.backward)*/}
                            ...
                            <InputGroup>
                                <LabeledIconButton
                                    ...
                                    title={'前景'/*this.props.intl.formatMessage(messages.front)*/}
                                    onClick={this.props.onSendToFront}
                                />
                                <LabeledIconButton
                                    disabled={!shouldShowSendBackward()}
                                    imgSrc={sendBackIcon}
                                    title={'背景'/*this.props.intl.formatMessage(messages.back)*/}
